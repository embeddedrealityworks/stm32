...
// Used by: USART1, USART1_S, USART2, USART2_S, USART3, USART3_S, UART4, UART4_S, UART5, UART5_S, USART6, USART6_S, UART7, UART7_S, UART8, UART8_S, UART9, UART9_S, USART10, USART10_S, USART11, USART11_S, UART12, UART12_S
...
// usart1_usart1_presc_v1: USART1_PRESC
// Used by: USART1, USART1_S, USART2, USART2_S, USART3, USART3_S, UART4, UART4_S, UART5, UART5_S, USART6, USART6_S, UART7, UART7_S, UART8, UART8_S, UART9, UART9_S, USART10, USART10_S, USART11, USART11_S, UART12, UART12_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using usart1_usart1_presc_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// usart1_usart1_rdr_v1: USART1_RDR
// Used by: USART1, USART1_S, USART2, USART2_S, USART3, USART3_S, UART4, UART4_S, UART5, UART5_S, USART6, USART6_S, UART7, UART7_S, UART8, UART8_S, UART9, UART9_S, USART10, USART10_S, USART11, USART11_S, UART12, UART12_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using usart1_usart1_rdr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::ro,
...
// usart1_usart1_tdr_v1: USART1_TDR
// Used by: USART1, USART1_S, USART2, USART2_S, USART3, USART3_S, UART4, UART4_S, UART5, UART5_S, USART6, USART6_S, UART7, UART7_S, UART8, UART8_S, UART9, UART9_S, USART10, USART10_S, USART11, USART11_S, UART12, UART12_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using usart1_usart1_tdr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
