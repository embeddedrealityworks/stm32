...
// lptim6_lptim6_dier_v1: LPTIM6_DIER
// Used by: LPTIM6, LPTIM6_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lptim6_lptim6_dier_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// lptim6_lptim6_dier_alternate1_v1: LPTIM6_DIER_ALTERNATE1
// Used by: LPTIM6, LPTIM6_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lptim6_lptim6_dier_alternate1_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// lptim6_lptim6_icr_v1: LPTIM6_ICR
// Used by: LPTIM6, LPTIM6_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lptim6_lptim6_icr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::wo,
...
// lptim6_lptim6_icr_alternate1_v1: LPTIM6_ICR_ALTERNATE1
// Used by: LPTIM6, LPTIM6_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lptim6_lptim6_icr_alternate1_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::wo,
...
// lptim6_lptim6_isr_v1: LPTIM6_ISR
// Used by: LPTIM6, LPTIM6_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lptim6_lptim6_isr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::ro,
...
// lptim6_lptim6_isr_alternate1_v1: LPTIM6_ISR_ALTERNATE1
// Used by: LPTIM6, LPTIM6_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lptim6_lptim6_isr_alternate1_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::ro,
...
// lptim6_lptim_arr_v1: LPTIM_ARR
// Used by: LPTIM6, LPTIM6_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lptim6_lptim_arr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// lptim6_lptim_ccmr1_v1: LPTIM_CCMR1
// Used by: LPTIM6, LPTIM6_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lptim6_lptim_ccmr1_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// lptim6_lptim_ccr1_v1: LPTIM_CCR1
// Used by: LPTIM6, LPTIM6_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lptim6_lptim_ccr1_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// lptim6_lptim_ccr2_v1: LPTIM_CCR2
// Used by: LPTIM6, LPTIM6_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lptim6_lptim_ccr2_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// lptim6_lptim_cfgr_v1: LPTIM_CFGR
// Used by: LPTIM6, LPTIM6_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lptim6_lptim_cfgr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// lptim6_lptim_cfgr2_v1: LPTIM_CFGR2
// Used by: LPTIM6, LPTIM6_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lptim6_lptim_cfgr2_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// lptim6_lptim_cnt_v1: LPTIM_CNT
// Used by: LPTIM6, LPTIM6_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lptim6_lptim_cnt_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::ro,
...
// lptim6_lptim_cr_v1: LPTIM_CR
// Used by: LPTIM6, LPTIM6_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lptim6_lptim_cr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// lptim6_lptim_rcr_v1: LPTIM_RCR
// Used by: LPTIM6, LPTIM6_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lptim6_lptim_rcr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
