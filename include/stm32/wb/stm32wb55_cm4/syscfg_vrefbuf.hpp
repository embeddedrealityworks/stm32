...
// syscfg_vrefbuf_syscfg_c2imr1_v1: SYSCFG_C2IMR1
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using syscfg_vrefbuf_syscfg_c2imr1_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// syscfg_vrefbuf_syscfg_c2imr2_v1: SYSCFG_C2IMR2
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using syscfg_vrefbuf_syscfg_c2imr2_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// syscfg_vrefbuf_syscfg_cfgr1_v1: SYSCFG_CFGR1
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using syscfg_vrefbuf_syscfg_cfgr1_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// syscfg_vrefbuf_syscfg_cfgr2_v1: SYSCFG_CFGR2
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using syscfg_vrefbuf_syscfg_cfgr2_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// syscfg_vrefbuf_syscfg_exticr1_v1: SYSCFG_EXTICR1
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using syscfg_vrefbuf_syscfg_exticr1_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// syscfg_vrefbuf_syscfg_exticr2_v1: SYSCFG_EXTICR2
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using syscfg_vrefbuf_syscfg_exticr2_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// syscfg_vrefbuf_syscfg_exticr3_v1: SYSCFG_EXTICR3
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using syscfg_vrefbuf_syscfg_exticr3_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// syscfg_vrefbuf_syscfg_exticr4_v1: SYSCFG_EXTICR4
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using syscfg_vrefbuf_syscfg_exticr4_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// syscfg_vrefbuf_syscfg_imr1_v1: SYSCFG_IMR1
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using syscfg_vrefbuf_syscfg_imr1_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// syscfg_vrefbuf_syscfg_imr2_v1: SYSCFG_IMR2
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using syscfg_vrefbuf_syscfg_imr2_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// syscfg_vrefbuf_syscfg_memrmp_v1: SYSCFG_MEMRMP
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using syscfg_vrefbuf_syscfg_memrmp_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// syscfg_vrefbuf_syscfg_scsr_v1: SYSCFG_SCSR
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using syscfg_vrefbuf_syscfg_scsr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// syscfg_vrefbuf_syscfg_sipcr_v1: SYSCFG_SIPCR
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using syscfg_vrefbuf_syscfg_sipcr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// syscfg_vrefbuf_syscfg_skr_v1: SYSCFG_SKR
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using syscfg_vrefbuf_syscfg_skr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::wo,
...
// syscfg_vrefbuf_syscfg_swpr_v1: SYSCFG_SWPR
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using syscfg_vrefbuf_syscfg_swpr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::wo,
...
// syscfg_vrefbuf_syscfg_swpr2_v1: SYSCFG_SWPR2
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using syscfg_vrefbuf_syscfg_swpr2_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::wo,
...
// syscfg_vrefbuf_vrefbuf_ccr_v1: VREFBUF_CCR
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using syscfg_vrefbuf_vrefbuf_ccr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// syscfg_vrefbuf_vrefbuf_csr_v1: VREFBUF_CSR
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using syscfg_vrefbuf_vrefbuf_csr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
