...
// tims_ccmr1_input_v3: CCMR1_INPUT
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
...
// tims_ccmr1_output_v3: CCMR1_OUTPUT
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using tims_ccmr1_output_v3_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// tims_ccmr2_output_v2: CCMR2_OUTPUT
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using tims_ccmr2_output_v2_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
