...
// usart_cr1_fifo_disabled_v1: CR1_FIFO_DISABLED
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using usart_cr1_fifo_disabled_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// usart_cr1_fifo_enabled_v1: CR1_FIFO_ENABLED
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using usart_cr1_fifo_enabled_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// usart_isr_fifo_disabled_v1: ISR_FIFO_DISABLED
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
...
// usart_isr_fifo_enabled_v1: ISR_FIFO_ENABLED
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
...
namespace usartx {
  ...
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using presc_tt = regs::lpuart_lpuart_presc_v1_tt<name, baseaddress, offset>;
