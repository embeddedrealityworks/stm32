...
#include <stm32/stm32f722/registers/usb_otg_hs.hpp>
...
namespace otg_hs_global {
  ...
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using otg_hs_hnptxsts_tt = regs::usb_otg_hs_otg_hs_hnptxsts_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  ...
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using otg_hs_gi2cctl_tt = regs::usb_otg_hs_otg_hs_gi2cctl_v1_tt<name, baseaddress, offset>;
...
namespace otg_hs_device {
  ...
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using otg_hs_diepdma0_tt = regs::usb_otg_hs_otg_hs_diepdma0_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  ...
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using otg_hs_doepdma1_tt = regs::usb_otg_hs_otg_hs_doepdma1_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using otg_hs_doepdma2_tt = regs::usb_otg_hs_otg_hs_doepdma2_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using otg_hs_doepdma3_tt = regs::usb_otg_hs_otg_hs_doepdma3_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using otg_hs_doepdma4_tt = regs::usb_otg_hs_otg_hs_doepdma4_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using otg_hs_doepdma5_tt = regs::usb_otg_hs_otg_hs_doepdma5_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using otg_hs_doepdma6_tt = regs::usb_otg_hs_otg_hs_doepdma6_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using otg_hs_doepdma7_tt = regs::usb_otg_hs_otg_hs_doepdma7_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using otg_hs_doepdma8_tt = regs::usb_otg_hs_otg_hs_doepdma8_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using otg_hs_doepdma9_tt = regs::usb_otg_hs_otg_hs_doepdma9_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using otg_hs_doepdma10_tt = regs::usb_otg_hs_otg_hs_doepdma10_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using otg_hs_doepdma11_tt = regs::usb_otg_hs_otg_hs_doepdma11_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using otg_hs_doepdma12_tt = regs::usb_otg_hs_otg_hs_doepdma12_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using otg_hs_doepdma13_tt = regs::usb_otg_hs_otg_hs_doepdma13_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using otg_hs_doepdma14_tt = regs::usb_otg_hs_otg_hs_doepdma14_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using otg_hs_doepdma15_tt = regs::usb_otg_hs_otg_hs_doepdma15_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  ...
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using otg_hs_diepdma6_tt = regs::usb_otg_hs_otg_hs_diepdma6_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using otg_hs_diepdma7_tt = regs::usb_otg_hs_otg_hs_diepdma7_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using otg_hs_diepdma8_tt = regs::usb_otg_hs_otg_hs_diepdma8_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using otg_hs_diepdma9_tt = regs::usb_otg_hs_otg_hs_diepdma9_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using otg_hs_diepdma10_tt = regs::usb_otg_hs_otg_hs_diepdma10_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using otg_hs_diepdma11_tt = regs::usb_otg_hs_otg_hs_diepdma11_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using otg_hs_diepdma12_tt = regs::usb_otg_hs_otg_hs_diepdma12_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using otg_hs_diepdma13_tt = regs::usb_otg_hs_otg_hs_diepdma13_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using otg_hs_diepdma14_tt = regs::usb_otg_hs_otg_hs_diepdma14_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using otg_hs_diepdma15_tt = regs::usb_otg_hs_otg_hs_diepdma15_v1_tt<name, baseaddress, offset>;
