...
namespace gpiof { inline constexpr std::uint32_t GPIOF_BASE = 0x4002'1800; } // namespace gpiof
namespace gpiog { inline constexpr std::uint32_t GPIOG_BASE = 0x4002'1c00; } // namespace gpiog
