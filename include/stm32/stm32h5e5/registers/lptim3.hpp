...
// lptim3_lptim3_dier_v1: LPTIM3_DIER
// Used by: LPTIM3, LPTIM3_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lptim3_lptim3_dier_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// lptim3_lptim3_dier_alternate1_v1: LPTIM3_DIER_ALTERNATE1
// Used by: LPTIM3, LPTIM3_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lptim3_lptim3_dier_alternate1_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// lptim3_lptim3_icr_v1: LPTIM3_ICR
// Used by: LPTIM3, LPTIM3_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lptim3_lptim3_icr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::wo,
...
// lptim3_lptim3_icr_alternate1_v1: LPTIM3_ICR_ALTERNATE1
// Used by: LPTIM3, LPTIM3_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lptim3_lptim3_icr_alternate1_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::wo,
...
// lptim3_lptim3_isr_v1: LPTIM3_ISR
// Used by: LPTIM3, LPTIM3_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lptim3_lptim3_isr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::ro,
...
// lptim3_lptim3_isr_alternate1_v1: LPTIM3_ISR_ALTERNATE1
// Used by: LPTIM3, LPTIM3_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lptim3_lptim3_isr_alternate1_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::ro,
...
// lptim3_lptim_arr_v1: LPTIM_ARR
// Used by: LPTIM3, LPTIM3_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lptim3_lptim_arr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// lptim3_lptim_ccmr1_v1: LPTIM_CCMR1
// Used by: LPTIM3, LPTIM3_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lptim3_lptim_ccmr1_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// lptim3_lptim_ccr1_v1: LPTIM_CCR1
// Used by: LPTIM3, LPTIM3_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lptim3_lptim_ccr1_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// lptim3_lptim_ccr2_v1: LPTIM_CCR2
// Used by: LPTIM3, LPTIM3_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lptim3_lptim_ccr2_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// lptim3_lptim_cfgr_v1: LPTIM_CFGR
// Used by: LPTIM3, LPTIM3_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lptim3_lptim_cfgr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// lptim3_lptim_cfgr2_v1: LPTIM_CFGR2
// Used by: LPTIM3, LPTIM3_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lptim3_lptim_cfgr2_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// lptim3_lptim_cnt_v1: LPTIM_CNT
// Used by: LPTIM3, LPTIM3_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lptim3_lptim_cnt_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::ro,
...
// lptim3_lptim_cr_v1: LPTIM_CR
// Used by: LPTIM3, LPTIM3_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lptim3_lptim_cr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// lptim3_lptim_rcr_v1: LPTIM_RCR
// Used by: LPTIM3, LPTIM3_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lptim3_lptim_rcr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
