...
// rng_rng_htcr1_v1: RNG_HTCR1
// Used by: RNG, RNG_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using rng_rng_htcr1_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// rng_rng_htcr2_v1: RNG_HTCR2
// Used by: RNG, RNG_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using rng_rng_htcr2_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// rng_rng_htcr3_v1: RNG_HTCR3
// Used by: RNG, RNG_S
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using rng_rng_htcr3_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
