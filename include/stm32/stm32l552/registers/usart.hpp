...
// usart_brr_v2: BRR
// Used by: USART1, SEC_USART1, USART2, SEC_USART2, USART3, SEC_USART3, UART4, UART5, SEC_UART4, SEC_UART5
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
...
// Used by: LPUART1, USART1, SEC_LPUART1, SEC_USART1, USART2, SEC_USART2, USART3, SEC_USART3, UART4, UART5, SEC_UART4, SEC_UART5
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
