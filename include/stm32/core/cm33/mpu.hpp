...
template <stdx::ct_string Name, std::uint32_t Baseaddress, std::uint32_t Offset>
using rlar_a1_tt = groov::reg<Name,
                              std::uint32_t,
                              Baseaddress + Offset,
                              common::access::rw,
...
template <stdx::ct_string Name, std::uint32_t Baseaddress, std::uint32_t Offset>
using rlar_a2_tt = groov::reg<Name,
                              std::uint32_t,
                              Baseaddress + Offset,
                              common::access::rw,
...
template <stdx::ct_string Name, std::uint32_t Baseaddress, std::uint32_t Offset>
using rlar_a3_tt = groov::reg<Name,
                              std::uint32_t,
                              Baseaddress + Offset,
                              common::access::rw,
