...
namespace tzsc {
  ...
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using tzsc_mpcwm1_upwwmr_tt = regs::tzsc_tzsc_mpcwm1_upwmr_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using tzsc_mpcwm2_upwmr_tt = regs::tzsc_tzsc_mpcwm1_upwmr_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using tzsc_mpcwm3_upwmr_tt = regs::tzsc_tzsc_mpcwm1_upwmr_v1_tt<name, baseaddress, offset>;
