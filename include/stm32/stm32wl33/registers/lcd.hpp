...
// lcd_lcd_ram_com1_v1: LCD_RAM_COM1
// Used by: LCD
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lcd_lcd_ram_com1_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// lcd_lcd_ram_com2_v1: LCD_RAM_COM2
// Used by: LCD
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lcd_lcd_ram_com2_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// lcd_lcd_ram_com3_v1: LCD_RAM_COM3
// Used by: LCD
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lcd_lcd_ram_com3_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// lcd_lcd_ram_com4_v1: LCD_RAM_COM4
// Used by: LCD
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lcd_lcd_ram_com4_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// lcd_lcd_ram_com5_v1: LCD_RAM_COM5
// Used by: LCD
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lcd_lcd_ram_com5_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// lcd_lcd_ram_com6_v1: LCD_RAM_COM6
// Used by: LCD
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lcd_lcd_ram_com6_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// lcd_lcd_ram_com7_v1: LCD_RAM_COM7
// Used by: LCD
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using lcd_lcd_ram_com7_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
