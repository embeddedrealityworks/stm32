...
// spi3_spi_sspcr1_v1: SPI_SSPCR1
// Used by: SPI3
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using spi3_spi_sspcr1_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// spi3_spi_sspcr2_v1: SPI_SSPCR2
// Used by: SPI3
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using spi3_spi_sspcr2_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// spi3_spi_sspcrcpr_v1: SPI_SSPCRCPR
// Used by: SPI3
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using spi3_spi_sspcrcpr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// spi3_spi_sspdr_v1: SPI_SSPDR
// Used by: SPI3
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using spi3_spi_sspdr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// spi3_spi_ssprxcrcr_v1: SPI_SSPRXCRCR
// Used by: SPI3
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using spi3_spi_ssprxcrcr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::ro,
...
// spi3_spi_sspsr_v1: SPI_SSPSR
// Used by: SPI3
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using spi3_spi_sspsr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// spi3_spi_ssptxcrcr_v1: SPI_SSPTXCRCR
// Used by: SPI3
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using spi3_spi_ssptxcrcr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::ro,
