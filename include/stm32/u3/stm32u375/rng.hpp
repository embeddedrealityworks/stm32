...
// rng_rng_htcr0_v1: RNG_HTCR0
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using rng_rng_htcr0_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
namespace rngx {
  ...
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using rng_htcr1_tt = regs::rng_rng_htcr0_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using rng_htcr2_tt = regs::rng_rng_htcr0_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using rng_htcr3_tt = regs::rng_rng_htcr0_v1_tt<name, baseaddress, offset>;
