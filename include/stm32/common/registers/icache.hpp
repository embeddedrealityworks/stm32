...
// icache_icache_crr0_v2: ICACHE_CRR0
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using icache_icache_crr0_v2_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// icache_icache_fcr_v2: ICACHE_FCR
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using icache_icache_fcr_v2_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::wo,
...
// icache_icache_fcr_v3: ICACHE_FCR
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using icache_icache_fcr_v3_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::wo,
...
// icache_icache_hmonr_v2: ICACHE_HMONR
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using icache_icache_hmonr_v2_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::ro,
...
// icache_icache_hmonr_v3: ICACHE_HMONR
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using icache_icache_hmonr_v3_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::ro,
...
// icache_icache_ier_v2: ICACHE_IER
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using icache_icache_ier_v2_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// icache_icache_mmonr_v2: ICACHE_MMONR
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using icache_icache_mmonr_v2_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::ro,
...
// icache_icache_mmonr_v3: ICACHE_MMONR
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using icache_icache_mmonr_v3_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::ro,
...
// icache_icache_sr_v2: ICACHE_SR
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using icache_icache_sr_v2_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::ro,
...
// icache_icache_sr_v3: ICACHE_SR
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using icache_icache_sr_v3_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::ro,
