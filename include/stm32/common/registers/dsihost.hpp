...
// dsihost_dsi_tccr4_v2: DSI_TCCR4
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using dsihost_dsi_tccr4_v2_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// dsihost_dsi_wifcr_v2: DSI_WIFCR
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
...
// dsihost_dsi_wpcr1_v2: DSI_WPCR1
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
...
// dsihost_dsi_wpcr2_v2: DSI_WPCR2
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
...
// dsihost_dsi_wpcr4_v2: DSI_WPCR4
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
