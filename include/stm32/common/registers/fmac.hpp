...
// fmac_fmac_sr_v2: FMAC_SR
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using fmac_fmac_sr_v2_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::ro,
...
// fmac_fmac_wdata_v2: FMAC_WDATA
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using fmac_fmac_wdata_v2_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::wo,
...
// fmac_x2bufcfg_v1: X2BUFCFG
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using fmac_x2bufcfg_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// fmac_ybufcfg_v1: YBUFCFG
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using fmac_ybufcfg_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
