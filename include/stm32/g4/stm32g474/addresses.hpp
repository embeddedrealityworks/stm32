...
namespace adc5 { inline constexpr std::uint32_t ADC5_BASE = 0x5000'0600; } // namespace adc5
...
namespace fdcan3 { inline constexpr std::uint32_t FDCAN3_BASE = 0x4000'6c00; } // namespace fdcan3
...
namespace hrtim_common { inline constexpr std::uint32_t HRTIM_COMMON_BASE = 0x4001'6b80; } // namespace hrtim_common
namespace hrtim_master { inline constexpr std::uint32_t HRTIM_MASTER_BASE = 0x4001'6800; } // namespace hrtim_master
namespace hrtim_tima { inline constexpr std::uint32_t HRTIM_TIMA_BASE = 0x4001'6880; } // namespace hrtim_tima
namespace hrtim_timb { inline constexpr std::uint32_t HRTIM_TIMB_BASE = 0x4001'6900; } // namespace hrtim_timb
namespace hrtim_timc { inline constexpr std::uint32_t HRTIM_TIMC_BASE = 0x4001'6980; } // namespace hrtim_timc
namespace hrtim_timd { inline constexpr std::uint32_t HRTIM_TIMD_BASE = 0x4001'6a00; } // namespace hrtim_timd
namespace hrtim_time { inline constexpr std::uint32_t HRTIM_TIME_BASE = 0x4001'6a80; } // namespace hrtim_time
namespace hrtim_timf { inline constexpr std::uint32_t HRTIM_TIMF_BASE = 0x4001'6b00; } // namespace hrtim_timf
