...
namespace timx_v7 {
  ...
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using or1_tt = regs::tim_or1_v4_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
...
namespace timx_v8 {
  ...
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using or1_tt = regs::tim_or1_v5_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using or2_tt = regs::tim_or2_v4_tt<name, baseaddress, offset>;
...
namespace timx_v9 {
  ...
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using or2_tt = regs::tim_or2_v5_tt<name, baseaddress, offset>;
...
namespace timx_v10 {
  ...
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using or1_tt = regs::tim_or1_v6_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using ccmr3_output_tt = regs::tim_ccmr3_output_v1_tt<name, baseaddress, offset>;
  ...
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using or2_tt = regs::tim_or2_v6_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
