...
// tim2_tim2_ccmr1_alternate1_v1: TIM2_CCMR1_ALTERNATE1
// Used by: TIM2, SEC_TIM2
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using tim2_tim2_ccmr1_alternate1_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// tim2_tim2_ccmr2_alternate1_v1: TIM2_CCMR2_ALTERNATE1
// Used by: TIM2, SEC_TIM2
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using tim2_tim2_ccmr2_alternate1_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
