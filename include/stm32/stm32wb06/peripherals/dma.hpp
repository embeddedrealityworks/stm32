...
#include <stm32/stm32wb06/registers/dma.hpp>
...
namespace dma {
  ...
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using dma_ccr8_tt = regs::dma_dma_ccr8_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using dma_cndtr8_tt = regs::dma_dma_cndtr8_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using dma_cpar8_tt = regs::dma_dma_cpar8_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using dma_cmar8_tt = regs::dma_dma_cmar8_v1_tt<name, baseaddress, offset>;
