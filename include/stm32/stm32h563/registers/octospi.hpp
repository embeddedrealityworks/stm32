...
// octospi_octospi_wabr_v1: OCTOSPI_WABR
// Used by: OCTOSPI, SEC_OCTOSPI
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using octospi_octospi_wabr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// octospi_octospi_wccr_v1: OCTOSPI_WCCR
// Used by: OCTOSPI, SEC_OCTOSPI
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using octospi_octospi_wccr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// octospi_octospi_wir_v1: OCTOSPI_WIR
// Used by: OCTOSPI, SEC_OCTOSPI
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using octospi_octospi_wir_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// octospi_octospi_wpabr_v1: OCTOSPI_WPABR
// Used by: OCTOSPI, SEC_OCTOSPI
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using octospi_octospi_wpabr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// octospi_octospi_wpir_v1: OCTOSPI_WPIR
// Used by: OCTOSPI, SEC_OCTOSPI
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using octospi_octospi_wpir_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// octospi_octospi_wptcr_v1: OCTOSPI_WPTCR
// Used by: OCTOSPI, SEC_OCTOSPI
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using octospi_octospi_wptcr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
