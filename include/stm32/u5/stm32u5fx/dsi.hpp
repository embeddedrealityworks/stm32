...
// dsi_dsi_dpcsrcr_v1: DSI_DPCSRCR
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using dsi_dsi_dpcsrcr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
// dsi_dsi_dpdl0bcr_v1: DSI_DPDL0BCR
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using dsi_dsi_dpdl0bcr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
using dsi_dsi_fbsr_v1_tt =
  groov::reg<name,
             ...
             common::access::rw,
               ...
               groov::field<"apbf", bool, 23, 23, common::access::ro>,
               groov::field<"apbe", bool, 22, 22, common::access::ro>,
               groov::field<"acbf", bool, 21, 21, common::access::ro>,
               groov::field<"acbe", bool, 20, 20, common::access::ro>,
               groov::field<"reserved1", std::uint8_t, 19, 18, common::access::ro>,
               groov::field<"vpbf", bool, 17, 17, common::access::ro>,
...
using dsi_dsi_gpsr_v1_tt =
  groov::reg<name,
             ...
             common::access::rw,
               groov::field<"reserved1", std::uint16_t, 31, 20, common::access::ro>,
               groov::field<"pbf", bool, 19, 19, common::access::ro>,
               groov::field<"pbe", bool, 18, 18, common::access::ro>,
               groov::field<"cmdbf", bool, 17, 17, common::access::ro>,
               groov::field<"cmdbe", bool, 16, 16, common::access::ro>,
...
namespace dsix {
  ...
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using dsi_dltcr_tt = regs::dsi_dsi_cltcr_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  ...
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using dsi_lcvcidr_tt = regs::dsi_dsi_lvcidr_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  ...
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using dsi_dpdl0srcr_tt = regs::dsi_dsi_dpcsrcr_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using dsi_dpdl1bcr_tt = regs::dsi_dsi_dpdl0bcr_v1_tt<name, baseaddress, offset>;
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using dsi_dpdl1srcr_tt = regs::dsi_dsi_dpcsrcr_v1_tt<name, baseaddress, offset>;
